        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default">
                    <div class="panel-heading"><i class="fa fa-user"></i>  Edit Chauffeur</div>
                    <div class="panel-body text-center">
                        {!! Form::model($chauffeur, array('class'=>'form-horizontal', 'method'=>'PATCH','action'=>['ChauffeurController@update',$chauffeur->id],'files'=>true)) !!}
                        {{ csrf_field() }}
