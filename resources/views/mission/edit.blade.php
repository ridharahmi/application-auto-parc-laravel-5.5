            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body text-center">
                        {!! Form::model($mission, array('class'=>'form-horizontal', 'method'=>'PATCH','action'=>['MissionController@update',$mission->id],'files'=>true)) !!}
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <label style="color:#2ca02c;">Km Ville: <b> {{ $mission->kmville }} </b> </label>
                                <br>
                                <label style="color:red;">Km Bond: {{ $mission->nmbonus }} </label>
                            </div>
                        </div>
