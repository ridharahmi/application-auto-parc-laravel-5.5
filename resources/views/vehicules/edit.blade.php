        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><i class="fa fa-car"></i> Edit Vehicules</div>
                    <div class="panel-body text-center">
                        {!! Form::model($vehicules, array('class'=>'form-horizontal', 'method'=>'PATCH','action'=>['VehiculesController@update',$vehicules->id],'files'=>true)) !!}
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6">
